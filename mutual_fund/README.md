<div align="center">
  ...
  <p>A beautiful, highly-performant Flutter application track Mutual Fund schemes.</p>
</div>
...
git clone https://github.com/your-username/mutual-fund-app.git
cd mutual-fund-app/mutual_fund
